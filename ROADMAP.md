...
### Step 3 — Tail-based sampling (OTel Collector) ✅
- [x] OTel Collector config 에 `tail_sampling` processor 추가 — composite policy: error / 5xx / latency > 500ms / random 1% (ADR-014)
