...
| **Phase 3** — 자체 Spring Boot 운영 라이브러리 (`modules/`) | 진행 중 (2/5 — slow-query-detector, jfr-recorder-starter 구현 / 나머지 3개는 설계 단계) |
...
├── modules/                 # Phase 3: 자체 Spring Boot 운영 라이브러리 (2/5 구현)
