...
/**
 * payment-service DLQ 메시지의 기본 저장소 — in-memory. ADR-026 의 표준 모양.
 *
 * 실제 source-specific 어댑터 (Kafka admin / outbox FAILED rows / PG callback failed log) wiring
 * 은 후속 step. 현재는 API 응답이 service 들 사이에 *같은 모양* 임을 보장하는 것이 우선.
 */
@Repository
